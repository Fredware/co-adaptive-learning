function [chans loss] = select_corr_zero_mean_darpa(X,Z,mvts,threshold,maxChans,varargin)
...
% based on: C:\Users\Marta Iversen\Downloads\Scripts\corrChanSelZeroMeanDarpa_jag.m
...
elseif strcmp(windowType, 'singMvt')
    ...
    for i = 1:size(sepX,1)
        [pSt,pEn] = jag_deng_utils.find_windows_darpa(sepX(i,:),0);
