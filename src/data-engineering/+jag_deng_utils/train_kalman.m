function [TRAIN,x,z]=train_kalman(x,z)
% based on: C:\Users\Marta Iversen\Downloads\Scripts\kalman_train.m
% notation from: http://bilgin.esme.org/BitsAndBytes/KalmanFilterforDummies
